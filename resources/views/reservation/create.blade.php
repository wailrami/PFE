                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form action="{{ route('reservations.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="time" name="start_time" min="06:00"  step="900" max="23:00" id="start_time" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:text-gray-200" >
                        </div>
                        @error('start_time')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
                        <div class="mb-4">
                            ...
                            <input type="time" name="end_time" min="06:15" step="900" max="23:30" id="end_time" class="mt-1 focus:ring-indigo-50023 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md dark:bg-gray-700 dark:text-gray-200" >
                        </div>
                        @error('end_time')
                            <span class="text-red-500">{{ $message }}</span>
                        @enderror
